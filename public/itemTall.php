...
<div class="container">
    ...
    $type_ref = 1;
    $id = $_GET['id'];
    $query = query(" SELECT * FROM coffee INNER JOIN size ON coffee.coffee_id = size.coffee_id WHERE size.type_ref = 1 AND coffee.coffee_id=" . escape_string($_GET['id']) . " ");
    confirm($query);
                        ...
                        <form method="post" action="../resources/functions.php">
                            ...
                            <div class="form-check">
                                <input
                                    ...
                                    id="flexRadioDefault1"
                                    value="3"
                                    onclick="location.href='itemVenti.php?id=<?php echo $id?>'"
                                />
